...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--hm-validation-n-jobs",
        type=int,
        default=None,
        help=(
            "CPU workers for pre-validating SMILES in HuggingMolecules builds. "
            "Default: all CPUs. Use 1 to disable parallel validation."
        ),
    )
    parser.add_argument(
        "--rdkit-fp-kind",
...
def build_representation_if_needed(
    ...
    hm_validation_n_jobs: Optional[int],
    force: bool,
) -> None:
    ...
    if representation_type == "huggingface":
        ...
        build_huggingmolecules_representation(
            ...
            hm_validation_n_jobs=hm_validation_n_jobs,
        )
    else:
...
def main() -> None:
    ...
    build_representation_if_needed(
        ...
        hm_validation_n_jobs=args.hm_validation_n_jobs,
        force=args.force,
    )
