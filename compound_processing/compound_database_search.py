...
"""Similarity search backends for provider-specific external compound databases.

This module is the neutral home of the search backend originally implemented
for ZINC. Legacy ZINC-specific entry points are intentionally preserved as
aliases/wrappers for backward compatibility.
"""
...
def search_similar_in_compound_database_torch_gpu(*args, **kwargs):
    """Neutral alias for the legacy GPU search entry point."""
    return search_similar_in_zinc_torch_gpu(*args, **kwargs)


def search_similar_in_compound_database_custom(*args, **kwargs):
    """Neutral alias for the legacy configurable search entry point."""
    return search_similar_in_zinc_custom(*args, **kwargs)
...
__all__ = [
    ...
    "get_compound_database_ligands",
    "get_zinc_ligands",
    "promote_representatives_by_pchembl",
    "search_similar_in_compound_database_custom",
    "search_similar_in_compound_database_torch_gpu",
    "search_similar_in_zinc_custom",
