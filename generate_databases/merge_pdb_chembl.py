...
def build_additional_hf_representation(
    data_dir,
    ...
    """Build an optional HuggingFace representation after the default Morgan flow."""
...
def merge_databases(data_dir, chemberta_rep=False, tanimoto_curation_threshold=0.35):
    ...
    # Optional extra embedding (kept disabled by default).
    if chemberta_rep is True:
        build_additional_hf_representation(data_dir)
    ...
    # Curate chembl ligands with multi-domain targets using Tanimoto similarity.
